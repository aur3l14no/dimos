...
all_modules = {
    ...
    "holonomic-path-follower": "dimos.navigation.dannav.holonomic_tc.path_follower.HolonomicPathFollower",
    ...
    "rerun-viewer-input-server": "dimos.visualization.rerun.viewer_input_server.RerunViewerInputServer",
